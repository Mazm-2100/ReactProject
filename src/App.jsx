...
//     };
//     let copy = [...phones];
//     copy[editPhoneIndex] = newPhoneObj;
//     setPhones(copy);
//   };
//   return (
...
//             <input
//               onChange={(event) => {
//                 setNewPhoneName(event.target.value);
//               }}
...
//             <input
//               onChange={(event) => {
//                 setNewPhonePrice(event.target.value);
//               }}
//               className="form-control my-3"
//               type="number"
...
//             <input
//               onChange={(event) => {
//                 setNewPhoneQty(event.target.value);
//               }}
//               className="form-control my-3"
//               type="number"
...
//             </div>
//             <input
//               defaultValue={phones[editPhoneIndex]?.name}
//               onChange={(event) => {
//                 setNewPhoneName(event.target.value);
//               }}
//               className="form-control my-3"
...
//             />
//             <input
//               defaultValue={phones[editPhoneIndex]?.price}
//               onChange={(event) => {
//                 setNewPhoneName(event.target.value);
//               }}
//               className="form-control my-3"
...
//             />
//             <input
//               defaultValue={phones[editPhoneIndex]?.qty}
//               onChange={(event) => {
//                 setNewPhoneName(event.target.value);
//               }}
//               className="form-control my-3"
